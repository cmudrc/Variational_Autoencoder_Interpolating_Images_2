...
# (box_matrix, box_density, additional_pixels, box_shape, "ground_truth")
# where "ground_truth" will be used to discern between various data augmentation techniques
